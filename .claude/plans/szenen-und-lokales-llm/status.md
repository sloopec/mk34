...
- Voraussetzung aus Plan 1: `fundament-und-kontext/TASK-002` (Router-Schnittstelle) und `TASK-003` (Store).
- Voraussetzung aus Plan 2: `agenten-kern-und-kontinuitaet/TASK-001/002` (Tools), `TASK-003` (Eval-Gerüst), `TASK-007/008` (Orchestrator/Pipeline-Slot), für TASK-004 zusätzlich `TASK-012/013` (Timeline/World-Rules).
- Nachgelagert: `qualitaet-workflow-und-export/TASK-001` (QS lokale Outputs) setzt TASK-004 voraus.
